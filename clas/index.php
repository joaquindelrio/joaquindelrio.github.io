...
$files = array();
	...
	while (false !== ($filename = readdir($dh))) {
		if(!in_array($filename, array("index.php",".","..",$logo,".htaccess")))
		{
			$files[] = $filename;
	...
	foreach ($files as $filename) {
		echo '<tr>';
			...
			echo '<a href="'.$filename.'" target="_blank">'.str_replace(".html","",$filename).'</a>';
			echo '</td>';
...
<br>
<br>
<p style="text-align:center">© 2013-<?=Date("Y");?> :: <a href="" target="_blank">quim</a> :: ts :: <a href="" target="_blank">T</a></p>
</div>
</body>
</html>
